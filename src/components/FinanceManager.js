...
<p style="font-size:11px;color:#999;margin-top:32px">Generated by MaraeHub · maraehub.co.nz · covers the whole organisation (the ledger has no per-entity split)</p>
</body></html>`);
    win.document.close();
    win.print();
  }
